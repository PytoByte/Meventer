...
public fun NavBackStackEntry.navDestination(navGraph: NavGraph = NavGraphs.register): Destination? {
...
public fun NavBackStackEntry.appDestination(navGraph: NavGraph = NavGraphs.register): Destination? {
    @Suppress("DEPRECATION")
    return destination(navGraph) as Destination
}
