...
fun CreateEventScreen(
    ...
    with(eventEditorViewModel) {
        ...
        val multiplePhotoPickerLauncher = rememberLauncherForActivityResult(
            ...
            onResult = {
                    uris -> extendSelectedImageUris(uris)
            }
        )
                ...
                Column {
                    if (imageEditor) {
                        Row(modifier = Modifier
                            .fillMaxWidth()
                            .heightIn(max = (animateImageEditor - 0.2f) * 100.dp), horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.CenterVertically) {
                                ...
                                Column {
                                    if (imageEditor) {
                                        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.CenterVertically) {
                                            IconButton(onClick = { removeSelectedImageUris(it) }, modifier=Modifier.padding(5.dp)) {
                                    ...
                                    AsyncImage(modifier = Modifier.fillMaxSize(), model = selectedImageUris[it], contentDescription = "image", contentScale = ContentScale.FillWidth)
                                }
                            }
                        }
                    }
